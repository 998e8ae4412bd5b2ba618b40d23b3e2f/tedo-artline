...
const Building = ({id}) => {
    return (
        <Container id={id}>
            <Text>
                <h2>Building <img src="/architecture/ui/yellow-arrow.svg" alt="arrow"/></h2>
                <PContainer>
                    <p>
            ...
            <BuildingImage/>
            <Line1 src={"/architecture/home/line-1.svg"} alt={"icon"}/>
            <Line2 src={"/architecture/home/line-2.svg"} alt={"icon"}/>
            <Line3 src={"/architecture/home/line-3.svg"} alt={"icon"}/>
        </Container>
    );
};
