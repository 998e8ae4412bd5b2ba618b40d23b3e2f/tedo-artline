        ...
        <Wrapper id={id}>
            <Container>
                {window.innerWidth > 768 ? <>
                        <Left>
                            <h2>Landscape Design <img src="/architecture/ui/yellow-arrow.svg" alt="arrow-icon"/></h2>
                            <ListContainer>
                                <List/>
                            </ListContainer>
            ...
            <Line1 src={"/architecture/home/landscape-line-1.svg"} alt={"line"}/>
            <Line2 src={"/architecture/home/landscape-line-2.svg"} alt={"line"}/>
            <Line3 src={"/architecture/home/landscape-line-3.svg"} alt={"line"}/>
        </Wrapper>
    );
};
