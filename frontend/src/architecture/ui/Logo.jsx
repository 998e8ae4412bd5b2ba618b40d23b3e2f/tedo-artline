...
const Logo = ({isMenu, isTransparent, isGrey}) => {
    ...
    return (
        <Container onClick={()=>navigateTo("/architecture/home")} isgrey={isGrey} transparent={isTransparent} ismenu={isMenu ? "true" : "false"}>
            {darkImage || isMenu ? <img src="/architecture/ui/header-logo-dark.svg" alt="logo"/> : <img src="/architecture/ui/header-logo.svg" alt="logo"/>}
