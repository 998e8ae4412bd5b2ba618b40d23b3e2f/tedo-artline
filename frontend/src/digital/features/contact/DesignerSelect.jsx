    ...
    return (
        <Container>
            <Item active={option === "ui-ux" ? "true" : "false"} onClick={() => setOption("ui-ux")}>
                UI/UX {t("main.contact.form.design")}</Item>
            <Item active={option === "graphic" ? "true" : "false"} onClick={() => setOption("graphic")}>
                Graphic {t("main.contact.form.design")}</Item>
            <Item active={option === "2d" ? "true" : "false"} onClick={() => setOption("2d")}>
                2D {t("main.contact.form.design")}</Item>
        </Container>
    );
};
