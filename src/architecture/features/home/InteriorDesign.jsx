...
const InteriorDesign = ({id}) => {
    ...
    return (
        <Container id={id}>
            <Text>
                <h2>Interior Design <img src="/architecture/ui/yellow-arrow.svg" alt="arrow"/></h2>
                <p>Explore Your Space with Artline Design</p>
            </Text>
            <ImageContainer>
                <GreyCircle src="/architecture/home/interior/grey-circle.svg" alt="circle"/>
                <YellowCircle src="/architecture/home/interior/yellow-circle.svg" alt="circle"/>
                <BlackCircle>
                    <img src="/architecture/home/interior/black-circle.svg" alt="circle"/>
                    <Button onClick={()=>navigateTo("/architecture/contacts")}><p>Try new</p></Button>
                </BlackCircle>
            </ImageContainer>
            <LineTop src={"/architecture/home/interior/line-1.svg"} alt={"line"}/>
            <LineBottom src={"/architecture/home/interior/line-2.svg"} alt={"line"}/>
